/**
 * The class Listops defines a number of static methods to work with lists using
 * the List class.
 */
public class ListOps extends List {

	/**
	 * Select and return the nth element of a list a. Assume that the nth
	 * element exists.
	 */
	...
	/**
	 * Creates a List which is the result of List b appended to the end of List
	 * a
	 */
	 ...
	 * 
	 * public static List addToEnd(List a, int x) { return append(a,
	 * List.cons(x, List.empty())); }
	 * 
	 */

	/**
	 * A naive implementation of reversing a List. Can take quite long on large
	 * lists
	 */
	...
	/**
	 * An efficient (tail recursive) implementation to reverse a List that uses
	 * a helper method and an accumulator
	 */
	public static List reverse(List list) {
		return reverseAccumulate(list, List.empty());
	}
