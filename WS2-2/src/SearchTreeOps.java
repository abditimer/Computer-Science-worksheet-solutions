 ...
 */
class SearchTreeOps extends TreeOps {
	/*
	 * Search for n in a tree t, and return the subtree whose root is n If n
	 * does not occur in the tree, throw an exception.
	 */
	...
	public static Tree listToTree(List l) {
		if (l.isEmpty()) {
			return new Tree();
		} else {
	...
	public static List treeSort(List l) {
