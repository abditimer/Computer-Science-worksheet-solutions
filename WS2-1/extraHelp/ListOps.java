...
public class ListOps extends List {
    ...
    */
     ...
     * on large lists
     */
    public static List slowReverse(List a) {
        if (a.isEmpty()) {
            return empty();
        } else {
            return addToEnd(slowReverse(a.getTail()), a.getHead());
        }
    }
    ...
    private static List reverseAccumulate(List original, List reversed) {
		...
		/* Return the maximum element of a list. Assume that there is an element. 
		 */
